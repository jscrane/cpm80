...
CPPFLAGS += -DUSE_Z80 -DPS2_SERIAL_KBD=\"UK\" -DHARDWARE_H=\"hw/ttgo-t7-v14-mini32.h\" -DVGA_BIT_DEPTH=1 -DVGA_RESOLUTION=VGAMode::MODE640x350
...
CPPFLAGS += -DUSER_SETUP_LOADED -DILI9341_DRIVER -DTFT_CS=5 -DTFT_DC=2 \
	...
	-DUSE_SD -DUSE_Z80 -DPROGRAMS=\"/cpm22/\" -DUSE_SERIAL \
