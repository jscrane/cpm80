...
CPPFLAGS += -DDVI_BIT_DEPTH=1 -DDVI_RESOLUTION=DVI_RES_640x240p60 -DSCREEN_SERIAL_DSP
...
CPPFLAGS += -DUSER_SETUP_LOADED -DILI9341_DRIVER -DTFT_CS=PIN_D8 -DTFT_DC=PIN_D1 \
	...
	-DHARDWARE_H=\"hw/esp8bit.h\" -DPS2_SERIAL_KBD=\"UK\" -DSCREEN_SERIAL_DSP
...
CPPFLAGS += -DPS2_SERIAL_KBD=\"UK\" -DHARDWARE_H=\"hw/ttgo-t7-v14-mini32.h\" \
	-DVGA_BIT_DEPTH=1 -DVGA_RESOLUTION=VGAMode::MODE640x350 -DSCREEN_SERIAL_DSP
LIBRARIES += PS2KeyAdvanced PS2KeyMap SPIFFS ESP32Lib
