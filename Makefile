...
CPPFLAGS += -DUSER_SETUP_LOADED -DILI9341_DRIVER -DTFT_CS=PIN_D8 -DTFT_DC=PIN_D1 \
	-DTFT_RST=-1 -DSPI_FREQUENCY=80000000 -DLOAD_GLCD -DLOAD_GFXFF \
	-DHARDWARE_H=\"hw/esp8bit.h\" -DUSE_HOST_KBD -DUSE_HOST_DISPLAY
#	-DHARDWARE_H=\"hw/esp8bit.h\" -DPS2_SERIAL_KBD=\"UK\"
#LIBRARIES += PS2KeyAdvanced PS2KeyMap TFT_eSPI SpiRAM FS LittleFS
LIBRARIES += SpiRAM FS LittleFS
endif
...
CPPFLAGS += -DPS2_SERIAL_KBD=\"UK\" -DUSE_SD -DPROGRAMS=$(SD_DIR) -DVGA_BIT_DEPTH=1 -DVGA_RESOLUTION=MODE640x480
...
#DebugLevel := verbose
PSRAM := enabled
CPPFLAGS += -DPS2_SERIAL_KBD=\"UK\" -DUSE_SD -DPROGRAMS=$(SD_DIR) -DVGA_BIT_DEPTH=1 -DVGA_RESOLUTION=MODE640x480 -DVGA_DEFAULT_FONT=Font8x8
LIBRARIES += PS2KeyAdvanced PS2KeyMap ESP32Lib SD
